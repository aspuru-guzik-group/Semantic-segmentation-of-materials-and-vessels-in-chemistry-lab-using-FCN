...
Note: RunPredictionOnFolder.py should run out of the box (as is) using the sample images and [trained model](https://zenodo.org/record/3697767) provided.
...
Train model for this net can be download from [here](https://zenodo.org/record/3697767).
